...
public class CxIgnoredProblemsView extends ViewPart implements IgnoredProblemsListener {
	...
	private void refreshView() {
		if (treeViewer != null && !treeViewer.getTree().isDisposed()) {
			try {
				if (allProblems != null) {
					List<ScanProblem> ignoredProblems = ignoredStore.getIgnoredProblems(allProblems);
					System.out.println("[IGNORED-VIEW] Displaying " + ignoredProblems.size() + " ignored problems");
